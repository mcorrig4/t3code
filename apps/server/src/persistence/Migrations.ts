...
import Migration0016 from "./Migrations/016_WebPushSubscriptions.ts";
import Migration0017 from "./Migrations/016_CanonicalizeModelSelections.ts";
...
export const migrationEntries = [
  ...
  [16, "WebPushSubscriptions", Migration0016],
