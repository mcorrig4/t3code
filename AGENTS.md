...
This repository is a maintained fork of `pingdotgg/t3code` with a capsule-aligned architecture, a documented enhancement ledger, and structured sync infrastructure. Proposing changes that improve long-term maintainability is encouraged.
